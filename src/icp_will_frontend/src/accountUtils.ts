// https://forum.dfinity.org/t/trouble-with-generating-account-identifiers-for-cketh-ckbtc-etc-via-icp-ledger-canister/30673
...
export const getAccountId = (principal: Principal) => {
