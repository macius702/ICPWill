...
const LEDGER_CANISTER_ID: &'static str = "ryjl3-tyaaa-aaaaa-aaaba-cai";
...
async fn transfer(args: TransferArgs) -> Result<BlockIndex, String> {
    ...
    let my_principal_id = ic_cdk::api::id();
    
    ic_cdk::println!("my_principal_id: {:?}", my_principal_id.to_text());
    ...
    ic_cdk::call::<(TransferFromArgs,), (Result<BlockIndex, TransferError>,)>(
