...
export default {
  ...
  methods: {
    ...
    async dodajChatMSG() {
      ...
      const backend = this.getAuthenticatedActor();
  ...
  let from_acc = { owner: Principal.fromText('zgcr3-w3e7h-6okfu-e5dke-k66xm-kadri-lvnuw-kipko-mysl7-r6p53-xae'), subaccount: [] };
